...
pygame.display.set_caption("Chohan's Platformer Game")
...
def generate_level():
    ...
    return objects, invisible_block
...
def main():
    ...
    while run_game:
        ...
        objects, invisible_block = generate_level()
        offset_x = 0
        ...
        while run:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN and player.hit_count > FPS * 2:
                    mouse_pos = event.pos
            ...
            if player.hit_count > FPS * 2:
                ...
                pygame.draw.rect(window, (0, 255, 0), restart_button)
